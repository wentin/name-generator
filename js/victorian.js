(function($) {
    $(function() {
        ...
        var stateReset = function() {
            ...
            $('.input.view').addClass('active');
            $('.outcome.view').removeClass('active');
        ...
        var stateAnswer = function(c) {
          pickName();
          $(".name.result").html(window.newFirstName + " <br/>" + window.newLastName);
...
window.fbAsyncInit = function() {
    FB.init({
        // for testing on local domain
        // appId      : "592339267522138",
        // for huffpost.com domain
